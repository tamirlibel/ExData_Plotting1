...
with(HPC_SUB, plot(DateTime, Global_active_power, xlab = '', ylab = "Global Active Power", type = "l"))
##Plotting the second plot
with(HPC_SUB, plot(DateTime, Voltage, xlab = "datetime", ylab = "Voltage", type = 'l'))
...
legend("topright",  col = c("black", "red", "blue"), lwd=1, legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.25)
